<template>
    <div v-if="isOpen" class="background-color-transparent my-3">
        <v-icon color="primary" class="mx-4" size="32" @click="isOpenCreation = true" :ripple="false">mdi-plus-circle</v-icon>
